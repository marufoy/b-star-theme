            ...
            <div class="contents">
                ...
                <div class="content" id="value">
                    <div class="text-content">
                        ...
                        <div class="text">
                            <h4>企業の数だけ「幸せ」がある</h4>
                            <p>企業はそれぞれ独自のビジョンと使命を持ち、それらは社会に幸せをもたらし、関わる人々に豊かな未来を届けています。私たちは企業がそのビジョンを実現するためのパートナーとして全力でサポートします。
                            製品やサービスを通じて、社会に貢献し、生活を豊かにし、環境を守る取り組みを最大限に引き出し、広めることを目指しています。</p>
                        </div>
                    </div>
                    <div class="image-content">
                        <picture>
